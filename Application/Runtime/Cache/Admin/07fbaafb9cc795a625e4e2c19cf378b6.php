        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/Replay/index',array('fenlei'=>$fenlei));?>">
                    <div class="dataTables_length" id="dataTables-example_length"><label>显示 
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info"></form>
                        <thead>
                            <tr role="row">
                            ...
                            <th  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="">评价内容</th>

                            <th  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="">回复内容</th>
                        ...
                        <tbody>
							<?php if(is_array($replays)): foreach($replays as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                ...
                                <td class="center">
                                    <a href="<?php echo U('Admin/Replay/edit', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i>修改</a>&nbsp;

                                    <a title= "删除回复" href="<?php echo U('Admin/Replay/delete', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-times"></i>删除</a>
