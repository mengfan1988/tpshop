...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">下架手机列表</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="dataTable_wrapper">
                    ...
                    <div class="dataTables_length" id="dataTables-example_length"><label>显示 
                        ...
                        <thead>
                            ...
                            <th   aria-label="Browser: activate to sort column ascending" style="">手机标题</th>
                        ...
                        <tbody>
							<?php if(is_array($phones)): foreach($phones as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                ...
                                <td class="center">
                                    ...
                                    <a style="margin-top: 5px"  href="<?php echo U('Admin/Phone/shangxian', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-long-arrow-up"></i>上线</a>    
                                    <a style="margin-top: 5px" title="删除" href="<?php echo U('Admin/Phone/delete', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-times"></i>删除</a>    
                                    <!-- <a href="<?php echo U('Admin/Phone/delete', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-times"></i></a> -->
