...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header"><?php echo ($huishou == 0? "订单列表" :'回收站'); ?></h3>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
                    <form action="<?php echo U('Admin/Order/index',array('huishou'=> 0));?>">
                    <div class="dataTables_length" id="dataTables-example_length"><label>显示 
                        <select name="num" aria-controls="dataTables-example" class="form-control input-sm">
                            <option value="5" <?php if($_GET['num'] == 5 ): ?>selected='selected'<?php endif; ?>  >5</option>
                        ...
                        <label>搜索:<input type="search" name="keyword" class="form-control input-sm" value='<?php echo ($keyword); ?>'placeholder="" aria-controls="dataTables-example"><button class="btn btn-primary">搜索</button></label></div></div></div><div class="row"><div class="col-sm-12">
                        ...
                        <thead>
                            <tr role="row">
                            <th  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="">订单号</th>

                            <th   aria-label="Browser: activate to sort column ascending" style="width:150px">订单金额</th>
                            
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" >支付银行</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" >物流</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" >物流单号</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width:100px">下单时间</th>
                        ...
                        <tbody>
                            <?php if(is_array($order)): foreach($order as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                <td class="sorting_1"><?php echo ($vo['ordernum']); ?></td>
                                <td><?php echo ($vo['qian']); ?></td>
                                
                               
                                <td><?php echo ($vo['bank']==0? '未支付' :'支付宝'); ?></td>
                                <td><?php switch($vo['yunshu']): case "0": ?>未发货<?php break;?>
                                            <?php case "1": ?>圆通<?php break;?>
                                            <?php case "2": ?>顺丰<?php break; endswitch;?></td>
                                <td><?php echo ($vo['yunshu']==0? '未发货':$vo['wuliunum']); ?></td>
                                ...
                                <td class="center">
                                    ...
                                    <a href="<?php echo U('Admin/Order/detail', array('id'=>$vo['id'],'orderNum'=>$vo['ordernum']));?>" class="btn btn-success btn-xs">查看</a>    
                                    <a  href="<?php echo U('Admin/Order/huishou', array('id'=>$vo['id'],'huishou'=>$vo['huishou']));?>" class="btn btn-success btn-xs"><?php echo ($huishou == 0? "回收站" :'还原'); ?></a> 
                                    <?php if($huishou == 1): ?><a  href="<?php echo U('Admin/Order/del', array('id'=>$vo['id'],'huishou'=>$vo['huishou'],'orderNum'=>$vo['ordernum']));?>" class="btn btn-success btn-xs">删除</a><?php endif; ?>
