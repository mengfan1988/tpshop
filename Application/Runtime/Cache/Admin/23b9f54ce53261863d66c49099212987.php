        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
                    <form action="<?php echo U('Admin/App/Hscateindex');?>">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                      ...
                      <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><tr>
                            ...
                            <?php if(is_array($vo['app'])): foreach($vo['app'] as $appkey=>$appvo): ?><tr>
                                ...
                                <td>
                                  <a class="btn btn-success btn-xs"  href="<?php echo U('Admin/App/catehuanyuan', array('id'=>$appvo));?>">还原</a>                                         
                                  <a class="label label-danger" href="<?php echo U('Admin/App/catedelete', array('id'=>$appvo));?>">彻底删除</a>                                         
                                </td>
