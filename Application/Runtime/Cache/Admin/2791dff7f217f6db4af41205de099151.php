        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/Shops/index');?>">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">店铺名</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 163px;">所在省市</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 163px;">电话</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 163px;">详细地址</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 163px;">附近交通</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 163px;">店铺实景</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 134px;">注册时间</th>
                        ...
                        <tbody>
							<?php if(is_array($shopss)): foreach($shopss as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                ...
                                <td> <img src="<?php echo ($vo['pic']); ?>" alt="" width="100" height="50"></td>
                                 <td class="center"><?php echo date('Y-m-d',$vo['ctime']);?></td>
                                <td class="center">
                                	<a href="<?php echo U('Admin/Shops/edit', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-edit"></i></a>&nbsp;
                                	<a href="<?php echo U('Admin/Shops/delete', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-times"></i></a>
                                </td>
