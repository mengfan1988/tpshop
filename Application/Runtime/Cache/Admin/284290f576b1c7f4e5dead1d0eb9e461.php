        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/Pic/index');?>">
                    <div class="dataTables_length" id="dataTables-example_length"><label>显示 
                        ...
                        <thead>
                            ...
                            <th  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="">缩略图</th>

                            <th  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="">商品名</th>
                            <th  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="">颜色</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" >用途</th>
                            
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" >排序</th>
                        ...
                        <tbody>
							<?php if(is_array($pics)): foreach($pics as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                <td class="sorting_1"><?php echo ($vo['id']); ?></td>
                                <td><img src="<?php echo ($vo['pic']); ?>" style="width:40px;height:45px"></td>
                                <td><?php echo ($vo['hostname']); ?></td>
                                <td><?php echo ($vo['color']); ?></td>
                                <td>
                                    <?php switch($vo['yongtu']): case "0": ?>轮播图<?php break;?>    
                                    <?php case "1": ?>详情图<?php break;?>    
                                    <?php case "2": ?>参数图<?php break; endswitch;?>

                                </td>

                                <td><?php echo ($vo['xu']); ?></td>
                                
                                <td class="center">
                                    <a href="<?php echo U('Admin/Pic/edit', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-edit">修改</i></a>

                                    <a href="<?php echo U('Admin/Pic/delete', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-times">删除</i></a>
