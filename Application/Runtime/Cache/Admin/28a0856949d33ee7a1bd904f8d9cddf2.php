...
<script type="text/javascript" src="/Public/Admin/js/style.js">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/Style/index');?>">
                    <div class="dataTables_length" id="dataTables-example_length"><label> 
                        ...
                        <table class="shuxingbiao table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                        </form>
                        <thead>
                            <tr role="row">
                            <th class="sorting_asc" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 155px;">属性</th>

                            <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">属性值</th></tr>
                            
                        </thead>
                        <tbody>
							<?php  foreach($styles as $v){?>
                                 <tr class="gradeA odd" role="row">
                                    <td class="sorting_1 shuxing" ><span keys='<?php echo $v[id]?>' guanxi="0"><?php echo $v['name']?></span></td>
                                        <td class="shuxingzhi">
                                        <?php  foreach($v['value'] as $vv){?>
                                            <span keys='<?php echo $vv['id']?>' guanxi="1"><?php echo $vv['name']?></span>          
                                        <?php }?>
                                        </td>
				...
				<style type="text/css">
                    ...
                    <div class="row"><div class="col-sm-6"></div><div class="col-sm-6"><div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                        <div id="pages">
                        <?php echo ($pages); ?>
                        </div>
                </div>
