                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%">
                            <form role="form" action="<?php echo U('Admin/Jifen/update');?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>兑换积分</label>
                                    <input name="price" type="text" class="form-control" value="<?php echo ($info['price']); ?>">
                                </div>
                                <div class="form-group">
                                    <label>上传Logo图片</label>
                                     <img src="<?php echo ($info['logo']); ?>" alt="" width="80px;">
                                    <div class="form-control" style="height:auto;">
                                     <input type="file" id="logoPic" name="logo" />
                                    </div>
