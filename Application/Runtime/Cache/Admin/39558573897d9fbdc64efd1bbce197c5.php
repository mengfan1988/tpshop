                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%">
                            <form role="form" action="<?php echo U('Admin/Jifen/updatepic');?>" method="post" enctype="multipart/form-data">
                                 
                                <div class="form-group">
                                    <label style="text-align:center;padding-left:100px;">上传详情图片<br>&nbsp;&nbsp;1张</label>
                                     <img src="<?php echo ($info['picdetail']); ?>" alt="" width="150px;">
