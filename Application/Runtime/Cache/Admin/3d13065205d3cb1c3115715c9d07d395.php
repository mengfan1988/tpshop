             ...
             <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">商品添加</h1>
                                ...
                                <div class="col-lg-12">
                                    <form role="form" action="<?php echo U('Admin/Phone/insert');?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>手机名</label>
                                            <input name="phoneName" type="text" class="form-control" placeholder="请输入手机名字">
                                        </div>
                                        <div class="form-group">
                                            <label>价格</label>
                                            <input name="price" type="text" class="form-control" placeholder="单位是元">
                                        </div>
                                        <div class="form-group">
                                            <label>原价</label>
                                            <input name="preprice" type="text" class="form-control" placeholder="默认是无">
                                        </div>
                                        <div class="form-group">
                                            <label>屏幕尺寸</label>
                                            <input name="screenSize" type="text" class="form-control" placeholder="单位是英寸">
                                        </div>                                 
                                        <div class="form-group">
                                            <label>库存</label>
                                            <input name="stock" type="text" class="form-control" placeholder="单位是台">
                                        </div>                                 
                                        <div class="form-group">
                                            <label>系列</label>
                                            <select class="form-control" name="series">

                                            <?php if(is_array($serieszhi)): foreach($serieszhi as $key=>$vo): ?><!-- <label class="radio-inline"> -->
                                                <option value="<?php echo ($vo['id']); ?>" ><?php echo ($vo['name']); ?></option>

                                                    <!-- <input type="radio" name="series" id="optionsRadiosInline1" value="<?php echo ($vo['id']); ?>" checked=""><?php echo ($vo['name']); ?> -->
                                       ...
                                       <div class="form-group">
                                            ...
                                            <?php if(is_array($typezhi)): foreach($typezhi as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" ><?php echo ($vo['name']); ?></option>

                                                 <!-- <label class="radio-inline" style="margin-left:0px ;width:70px">
                                                    <input type="radio" name="type" id="optionsRadiosInline1" value="<?php echo ($vo['id']); ?>" checked=""><?php echo ($vo['name']); ?>
                                                </label> --><?php endforeach; endif; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if(is_array($netzhi)): foreach($netzhi as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" ><?php echo ($vo['name']); ?></option>

                                                 <!-- <label class="radio-inline" style="margin-left:0px ;width:100px">
                                                    <input type="radio" name="network" id="optionsRadiosInline1" value="<?php echo ($vo['id']); ?>" checked=""><?php echo ($vo['name']); ?> 
                                                </label> --><?php endforeach; endif; ?>
                                           </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="optionsRadiosInline1" value="0" checked="">普通
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="optionsRadiosInline1" value="1" checked="">新品
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="optionsRadiosInline1" value="2" checked="">爆款
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="optionsRadiosInline1" value="3" checked="">促销
                                            </label>
                                        ...
                                        <div class="form-group">
                                            <label>颜色</label><br>
                                            <?php if(is_array($colorzhi)): foreach($colorzhi as $key=>$vo): ?><div class="checkbox-inline" style="margin-left:0px ;width:70px">
                                                <label>
                                                    <input name="phoneColor[]" type="checkbox" value="<?php echo ($vo['id']); ?>"><?php echo ($vo['name']); ?>
                                                </label>
