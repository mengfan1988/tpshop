        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
                    <form action="<?php echo U('Admin/App/cateindex');?>">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                        ...
                        <thead>
                            <tr role="row">
                                <th class="sorting_asc" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 155px;">分类树</th>
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">ID</th>
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">分类名称</th>
                        ...
                        <tbody>
                      <?php if(is_array($cates)): foreach($cates as $key=>$vo): ?><!-- <?php if($vo["pid"] == 0): ?>-->
                            <tr>
                              <td><img src="/buy/Public/Admin/Images/dirfirst.gif" alt=""></td>
                              <td><?php echo ($vo["id"]); ?></td>
                              <td><?php echo ($vo["name"]); ?></td>
                              <!-- <td>
                                  <a class="label label-danger" style="margin-right:10px" onclick="return confirm('这将会把整个栏目下的应用全部放入回收站，请谨慎操作')" href="<?php echo U('Admin/App/cateqb', array('id'=>$vo['id']));?>">全部回收</a>                                         
                                </td> -->
                            </tr>
                             <?php if(is_array($vo['app'])): foreach($vo['app'] as $appkey=>$appvo): ?><tr>
                                <td><img src="/buy/Public/Admin/Images/dirsecond.gif" alt=""></td>
                                <td><?php echo ($appvo); ?></td>
                                <td><?php echo ($appkey); ?></td>
                                <td>
                                  <a class="btn btn-success btn-xs" style="margin-right:10px" href="<?php echo U('Admin/App/catehuishou', array('id'=>$appvo));?>">回收</a>                                         
                                  <a href="<?php echo U('Admin/App/cateedit', array('id'=>$appvo));?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                </td>
                              </tr><?php endforeach; endif; ?>
                         <!-- <?php else: endif; ?> --><?php endforeach; endif; ?>
                        </tbody>
                    </table></div></div>
                    <style type="text/css">
                        #pages a,#pages span{
