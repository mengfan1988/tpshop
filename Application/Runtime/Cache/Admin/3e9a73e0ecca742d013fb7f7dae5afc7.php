                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%">
                            <form role="form" action="<?php echo U('Admin/App/insertApp');?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                     <label>设为热门</label>
                                     <input style="margin-right:20px" name="hot" id="hot" type="radio" value="1" />
                                ...
                                <div class="form-group">
                                    <label>上传应用Logo图片</label>
                                    <div class="form-control" style="height:auto;">
                                     <input type="file" id="logoPic" name="pic[]" />
                                    </div>
                                </div>

                                <!-- <div class="form-group">
                                    <label>请选择商品幻灯展示图片（3张）</label>
                                    <div class="form-control" style="height:auto;">
                                ...
                                <div class="form-group">
                                    <label>应用详情</label>
                                    <textarea class="form-control"name="appdetail" style="height:auto;width:100%;"></textarea>
                                </div>
