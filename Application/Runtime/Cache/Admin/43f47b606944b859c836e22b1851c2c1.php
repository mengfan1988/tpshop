        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="<?php echo U('Admin/Part/insert');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>配件标语</label>
                                    <input name="partName" type="text" class="form-control" placeholder="请输入配件名字">
                                </div>
                                <div class="form-group">
                                    <label>价格</label>
                                ...
                                <div class="form-group">
                                    <label>库存</label>
                                    <input name="stock" type="text" class="form-control" placeholder="单位是个">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="app">
                                        <?php if(is_array($appzhi)): foreach($appzhi as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo['name']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>颜色</label>
                                    <select class="form-control" name="partColor">
                                        <?php if(is_array($colorzhi)): foreach($colorzhi as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo['name']); ?></option><?php endforeach; endif; ?>        
                                    </select>    
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="sx" id="optionsRadiosInline1" value="0" checked="">上线
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="sx" id="optionsRadiosInline1" value="1" checked="">下架
                                    </label>
                               ...
                               <div class="form-group">
                                    ...
                                    <?php if(is_array($typezhi)): foreach($typezhi as $key=>$vo): ?><div class="checkbox-inline" style="margin-left:0px ;width:100px">   
                                         <label >
                                            <input type="checkbox" name="type[]" id="optionsRadiosInline1" value="<?php echo ($vo['id']); ?>" ><?php echo ($vo['name']); ?>
                                        </label>
