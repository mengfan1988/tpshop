        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/App/Appindex');?>">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                        ...
                        <tbody>
							<?php if(is_array($apps)): foreach($apps as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                ...
                                <td>
                                <?php switch($vo['tid']): case "1": ?>游戏<?php break;?>
                                    <?php case "2": ?>应用<?php break;?>
                                    <?php case "3": ?>专题<?php break;?>
                                    <?php case "4": ?>主题<?php break; endswitch;?>  
                                </td>
                                <td> <img src="<?php echo ($vo['pic']); ?>" alt="" width="80" ></td>
                                ...
                                <td class="center">
                                    <a href="<?php echo U('Admin/App/Appedit', array('id'=>$vo['id'],'cid'=>$vo['tid']));?>" class="btn btn-success btn-xs"><i class="fa fa-edit">修改</i></a>&nbsp;&nbsp;
                                	<a href="<?php echo U('Admin/App/Appdelete', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-times">删 除</i></a>&nbsp;
                                    <a href="<?php echo U('Admin/App/huishou', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-long-arrow-down"></i>放入回收站</a>&nbsp;&nbsp;
                                    <a href="<?php echo U('Admin/App/JieTuedit', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-edit">修改应用截图</i></a>
