        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/Rule/index');?>">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">规则名称</th>
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">规则</th>
                        ...
                        <tbody>
							<?php if(is_array($rules)): foreach($rules as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                <td class="sorting_1"><?php echo ($vo['id']); ?></td>
                                <td><?php echo ($vo['title']); ?></td>
                                <td><?php echo ($vo['name']); ?></td>
                                <td class="center">
                                	<a href="<?php echo U('Admin/Rule/edit', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-edit"></i></a>&nbsp;
                                	<a href="<?php echo U('Admin/Rule/delete', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-times"></i></a>
                                </td>
