...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">IMEI列表</h3>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/Link/index');?>" method="post">
                    ...
                    <div class="row">
                    <div class="col-sm-12">
                    <table style="text-align:center;" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                </form>
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting_asc" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 155px;">手机名称</th>
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">手机图片</th>
                                <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 163px;">IMEI号</th>
                        ...
                        <tbody>
							<?php if(is_array($info)): foreach($info as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                ...
                                <td><?php echo ($vo['phone']['phoneName']); ?></td>
                                <td><img src="<?php echo ($vo['phone']['pic']); ?>" alt="" style="height:50px;"></td>
                                <td><?php echo ($vo['imei']); ?></td>
                                <td class="center">
                                	<a href="<?php echo U('Admin/IMEI/edit', array('id'=>$vo['id'],'imei'=>$vo['imei']));?>" class="btn btn-primary btn-circle"><i class="fa fa-edit"></i></a>&nbsp;
                                	<a href="<?php echo U('Admin/IMEI/delete', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-times"></i></a>
                                </td>
