...
<body>
 ...
 <style type="text/css">
    *{ font-family:微软雅黑;
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">网站配置信息</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                            <form role="form" action="<?php echo U('Admin/WZPZ/update');?>" method="post" enctype="multipart/form-data">
                              

                                <div class="form-group">
                                    <label>网站名称</label>
                                    <input name="name" type="text" class="form-control" value="<?php echo ($res['name']); ?>">
                                    
                                </div>
                                 <div class="form-group">
                                    <label>网站关键子</label>
                                    <input name="guanjianzi" type="text" class="form-control" value="<?php echo ($res['guanjianzi']); ?>">
                                    
                                </div>
                                 <div class="form-group">
                                    <label>网站版权</label>
                                    <input name="banquan" type="text" class="form-control" value="<?php echo ($res['banquan']); ?>">
                                    
                                </div>

                                <div class="form-group">
                                    <label>备案号</label>
                                    <input name="beian" type="text" class="form-control" value="<?php echo ($res['beian']); ?>">
                                    
                                </div>
                                <div class="form-group">
                                    <label>咨询电话</label>
                                    <input name="phone" type="text" class="form-control" value="<?php echo ($res['phone']); ?>">
                                    
                                </div>
                                <div class="form-group">
                                    <label>客服QQ</label>
                                    <input name="QQ" type="text" class="form-control" value="<?php echo ($res['QQ']); ?>">
                                    
                                </div>
                                <div class="form-group">
                                    <label>公司地址</label>
                                    <input name="dizhi" type="text" class="form-control" value="<?php echo ($res['dizhi']); ?>">
                                    
                                </div>
                                <div class="form-group">
                                    <label>网站开关</label><br />
                                    <input name="status" type="radio"  value="开">开
                                    <input name="status" type="radio"  value="关">关
                                    
                                </div>
                                 <div class="form-group">
                                    <label>网站LOGO</label>
                                    <input type="file" name="pic">
                                    <img src="/buy/Public<?php echo ($res['pic']); ?>" width="100px">
                                </div>
                                <div class="form-group">
                                    <label>关闭原因</label>
                                    <input name="yuanyin" type="text" class="form-control" value="<?php echo ($res['yuanyin']); ?>">
