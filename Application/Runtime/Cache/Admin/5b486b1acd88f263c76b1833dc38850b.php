...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">赠品/套餐添加</h1>
        </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="<?php echo U('Admin/Gift/insert');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>赠品/套餐标语</label>
                                    <input name="title" type="text" class="form-control" placeholder="请输入配件名字">
                                </div>
                                <div class="form-group">
                                    <label>请选择添加类型</label>
                                    <select class="form-control" name="gm">
                                        
                                        <option value="0">添加赠品</option>
                                        <option value="1">添加套餐</option>
                                ...
                                <div class="form-group">
                                    <label>请选择赠品/套餐商品</label>
                                    <select class="form-control" name="partId">
                                        <?php if(is_array($parts)): foreach($parts as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"><?php echo ($vo['partname']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>请选择手机</label>
                                    <select class="form-control" name="phoneId">
                                        <?php if(is_array($phones)): foreach($phones as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" <?php echo I('get.phoneid') == $vo['id'] ? selected : '' ;?>><?php echo ($vo['phonename']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                               <div class="form-group">
                                    <label>赠品/套餐商品数量</label>
                                    <input name="num" type="text" class="form-control" placeholder="请输入赠品数量">
                                </div>
                                 
                                 <div class="form-group">
                                    <label>套餐的价格</label>
                                    <input name="price" type="text" class="form-control" placeholder="0元" value="0">
                                </div>
