    ...
    <div class="row" >
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <form action="<?php echo U('Admin/Replay/update');?>" method="post">
                        <div class="panel-body">
                            <div class="alert ">
                                <script id="editor" name="content" type="text/plain" style="width:400px;height:300px;"><?php echo ($content); ?></script>                            
                                
                               
                                <input type="hidden"   name="id" value="<?php echo ($id); ?>">
                                <input type="hidden"   name="fenlei" value="<?php echo ($fenlei); ?>">
                                <input type="submit"  class="btn btn-success btn-lg btn-block " style="width:80%;margin-left:10%;margin-top:5%" value="修改">
                            </div>
