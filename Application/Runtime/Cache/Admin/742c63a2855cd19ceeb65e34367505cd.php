...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/20160727/buy/Public/Admin/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="/20160727/buy/Public/Admin/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="/20160727/buy/Public/Admin/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/20160727/buy/Public/Admin/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/20160727/buy/Public/Admin/bower_components/morrisjs/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/20160727/buy/Public/Admin/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <![endif]-->
    <script src="/20160727/buy/Public/Admin/bower_components/jquery/dist/jquery.min.js"></script>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="/20160727/buy/Public/Home/Images/oppo_logo.png" alt="" class="dropdown-toggle">
 ...
 <script type="text/javascript" charset="utf-8" src="/20160727/buy/Public/Admin/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/20160727/buy/Public/Admin/ueditor/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="/20160727/buy/Public/Admin/ueditor/lang/zh-cn/zh-cn.js"></script>
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">评价回复</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
    <div class="row" >
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="alert alert-success">
                                <?php echo ($ping['content']); ?>
                            </div>

                            <div class="alert ">
                               <?php  if($ping['pic']== '0'){ echo '无图'; }else{ foreach($ping['pic'] as $v){ echo '<img src="'.$v.'" alt="">' ; } } ?>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <form action="<?php echo U('Admin/Replay/insert');?>" method="post">
                        <div class="panel-body">
                            <div class="alert ">
                                <script id="editor" name="content" type="text/plain" style="width:400px;height:300px;"></script>                            
                                <input type="hidden" name="aid" value="<?php echo ($aid); ?>">
                                <input type="hidden" name="fenlei" value="<?php echo ($fenlei); ?>">
                            <input type="submit"  class="btn btn-success btn-lg btn-block " style="width:80%;margin-left:10%;margin-top:5%" value="回复">
                            </div>
    ...
    <script src="/20160727/buy/Public/Admin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="/20160727/buy/Public/Admin/bower_components/metisMenu/dist/metisMenu.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="/20160727/buy/Public/Admin/bower_components/raphael/raphael-min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="/20160727/buy/Public/Admin/dist/js/sb-admin-2.js"></script>
