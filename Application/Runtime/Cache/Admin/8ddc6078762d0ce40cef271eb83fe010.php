        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="<?php echo U('Admin/Part/update');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>配件标语</label>
                                    <input name="partName" type="text" class="form-control" value= "<?php echo ($part['partname']); ?>"placeholder="请输入配件名字">
                                </div>
                                <div class="form-group">
                                    <label>价格</label>
                                    <input name="price" type="text" class="form-control" value= "<?php echo ($part['price']); ?>" >
                                </div>
                                <div class="form-group">
                                    <label>原价</label>
                                    <input name="preprice" type="text" class="form-control" value= "<?php echo ($part['preprice']); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="app">
                                        <?php if(is_array($appzhi)): foreach($appzhi as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" <?php echo ($part['app'] == $vo['id'] ? selected :''); ?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>颜色</label>
                                    <select class="form-control" name="partColor">
                                    <?php if(is_array($colorzhi)): foreach($colorzhi as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" <?php echo ($part['partColor'] == $vo['id'] ? selected :''); ?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                               <!-- <div class="form-group">
                                    <label>颜色</label><br>
                                    <?php if(is_array($colorzhi)): foreach($colorzhi as $key=>$vo): ?><label class="radio-inline">
                                            <input name="partColor" type="radio" value="<?php echo ($vo['id']); ?>" <?php echo ($part['partColor'] == $vo['id'] ? checked :''); ?>><?php echo ($vo['name']); ?>
                                        </label><?php endforeach; endif; ?>
                                </div> -->
                                <div class="form-group">
                                    <label>销售状态</label><br>
                                    <label class="radio-inline">
                                        <input type="radio" name="sx" id="optionsRadiosInline1" value="0" <?php echo ($part['status'] == 0 ? checked :''); ?>>上线
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="sx" id="optionsRadiosInline1" value="1" <?php echo ($part['status'] == 1 ? checked :''); ?>>下架
                                    </label>
                               ...
                               <div class="form-group">
                                    ...
                                    <?php if(is_array($typezhi)): foreach($typezhi as $key=>$vo): ?><div class="checkbox-inline" style="margin-left:0px ;width:100px">   
                                         <label >
                                            <input type="checkbox" name="type[]" id="optionsRadiosInline1" value="<?php echo ($vo['id']); ?>" <?php echo in_array($vo['id'],$types)? checked : '';?>><?php echo ($vo['name']); ?>
                                        </label>
                                ...
                                <div class="form-group">
                                    <label>配件主图</label>
                                    <img src="<?php echo ($part['pic']); ?>" style="width:60px">
                                    <input type="file" name="pic">
                                   
                                </div>
                                
                                    <input name="id" type="hidden" class="form-control" value="<?php echo ($part['id']); ?>">
