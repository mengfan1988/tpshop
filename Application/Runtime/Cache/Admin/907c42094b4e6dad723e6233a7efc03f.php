...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">友情链接修改</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%">
                            <form role="form" action="<?php echo U('Admin/Link/update');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group" style="width:100%">
                                    <label>网站名称</label>
                                    <input value="<?php echo ($info['name']); ?>" name="name" type="text" class="form-control" remind="请输入2~10位字母数字下划线">
                                    <span ></span>
                                </div>
                                <div class="form-group" style="width:100%">
                                    <label >网站链接</label>
                                    <input value="<?php echo ($info['link']); ?>" name="link" type="text" class="form-control" remind="请输入5~10非空白字符">
                                    <span ></span>
                                </div>
