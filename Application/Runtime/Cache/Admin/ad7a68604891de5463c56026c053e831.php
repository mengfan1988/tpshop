...
<body>
 ...
 <style type="text/css">
    *{ font-family:微软雅黑;
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">IMEI修改</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                            <form role="form" action="<?php echo U('Admin/IMEI/update');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <!-- <label>请选择手机</label> -->
                                    <input name="" type="text" class="form-control" value="<?php echo ($res['phoneName']); ?>" readonly="">
                                </div>

                                <div class="form-group">
                                    <label>IMEI号</label>
                                    <input name="imei" type="text" class="form-control" value="<?php echo ($res['imei']); ?>">
