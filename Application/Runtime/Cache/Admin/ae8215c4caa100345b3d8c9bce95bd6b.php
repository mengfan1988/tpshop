                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%">
                            <form role="form" action="<?php echo U('Admin/App/JieTuupdate');?>" method="post" enctype="multipart/form-data">
                               
                                <div class="form-group">
                                    <?php if(is_array($imgres)): foreach($imgres as $key=>$vo): ?><img src="<?php echo ($vo['pic']); ?>" alt="" width=100px;><?php endforeach; endif; ?>
                                    <label>请上传要修改的商品截图展示(3张)</label>
                                ...
                                <input type="hidden" name="aid" value="<?php echo ($vo['aid']); ?>">
                                <!-- 这个id用于用户在之前截图表没有数据时 做添加所用-->
