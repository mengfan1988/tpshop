                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                            <form role="form" action="<?php echo U('Admin/Shops/update');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>体验店名称</label>
                                    <input name="shopname" type="text" value="<?php echo ($info['shopname']); ?>" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>服务电话</label>
                                    <input name="tel" type="text" value="<?php echo ($info['tel']); ?>" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>详细地址</label>
                                    <input name="address" type="text" value="<?php echo ($info['address']); ?>" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>营业时间</label>
                                    <input name="runtime" type="text" value="<?php echo ($info['runtime']); ?>" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>附近公交地铁</label>
                                    <input name="traffic" type="text" value="<?php echo ($info['traffic']); ?>" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>店铺所在地</label><br>
                                    <?php echo ($city); ?>
                                </div>
                                
                                <div class="form-group">
                                    <label>店内实景图</label><br>
                                    <img src="<?php echo ($info['pic']); ?>" alt="" width="200px;">

                                    <input type="file" name="pic" value="<?php echo ($info['pic']); ?>">
                                </div>
