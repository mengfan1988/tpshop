...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="/Public/Home/Images/oppo_logo.png" alt="" class="dropdown-toggle">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">应用修改</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
    <div class="row" style="margin:0 auto;width:40%;">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                  <img src="/Public/Home/Images/oppo_logo.png" alt="">
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%">
                            <form role="form" action="<?php echo U('Admin/App/AppUpdate');?>" method="post" enctype="multipart/form-data">
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>应用版本</label>
                                    <input name="version" type="text" class="form-control" value="<?php echo ($info['version']); ?>">
                                </div>
                                <div class="form-group">
                                    <label>支持操作系统</label>
                                    <input name="operating" type="text" class="form-control" value="<?php echo ($info['operating']); ?>">
                                </div>
                                <div class="form-group">
                                     <label>设为热门</label>
                                     <input style="margin-right:20px" <?php if(($info['hot']) == "1"): ?>checked<?php endif; ?> name="hot" type="radio" value="1"/>
                                     <label for="recommend">设为小编推荐</label>
                                     <input type="radio" <?php if(($info['recommend']) == "1"): ?>checked<?php endif; ?> name="recommend" value="1" />
                                </div>
                                <div class="form-group">
                                    <label>请上传要修改的应用Logo图片</label>
                                    <div class="form-control" style="height:auto;">
                                     <img src="<?php echo ($info['pic']); ?>" alt="" width=100px;>
                                     <input type="file" name="pic[]" />
                                    </div>
                                </div>
                               <!--  <div class="form-group">
                                    <label>请选择商品截图展示（3张）</label>
                                    <div class="form-control" style="height:auto;">
                                ...
                                <div class="form-group">
                                    <label>应用详情</label>
                                    <textarea class="form-control" name="appdetail" style="height:auto;width:100%;"><?php echo ($info['appdetail']); ?></textarea>
                                </div>
