        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                  <img src="/buy/Public/Home/Images/oppo_logo.png" alt="">
                        ...
                        <div class="col-lg-6" style="width:100%;">
                            <form role="form" action="<?php echo U('Admin/User/update');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>用户名</label>
                                    <input name="username" value="<?php echo ($info['username']); ?>" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>年龄</label>
                                    <input name="age" value="<?php echo ($info['age']); ?>" type="text" class="form-control" >
                                </div>
                                <div class="form-group">
                                    <label>email</label>
                                    <input name="email" value="<?php echo ($info['email']); ?>" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>真实姓名</label>
                                    <input name="realname" value="<?php echo ($info['realname']); ?>" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>性别</label><br>
                                    <label class="radio-inline">
                                        <input type="radio"  <?php if($info['sex'] == 0): ?>checked<?php endif; ?> name="sex" id="optionsRadiosInline1" value="0" checked="">女
                                    </label>
                                    <label class="radio-inline">
                                        <input <?php if($info['sex'] == 1): ?>checked<?php endif; ?> type="radio" name="sex" id="optionsRadiosInline2" value="1">男
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label>用户组</label>
                                    <select class="form-control" name="groups">
                                        <option value="编辑" <?php if($info['groups'] == '编辑'): ?>selected<?php endif; ?>>编辑</option>
                                        <option value="管理员" <?php if($info['groups'] == '管理员'): ?>selected<?php endif; ?> >管理员</option>
                                        <option value="普通用户" <?php if($info['groups'] == '普通用户'): ?>selected<?php endif; ?>>普通用户</option>
                                    </select>
                                </div>
                                <img src="<?php echo ($info['img']); ?>" alt="" width="200">
                                <div class="form-group">
                                    <label>用户的头像</label>
