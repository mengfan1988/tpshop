...
<body>
 ...
 <style type="text/css">
    *{ font-family:微软雅黑;
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">友情链接添加</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                            <form role="form" action="<?php echo U('Admin/IMEI/insert');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>请选择手机</label>
                                    <select class="form-control" name="phone">
                                        <?php if(is_array($phone)): foreach($phone as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"}><?php echo ($vo['phoneName']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
