...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">手机图片添加</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" action="<?php echo U('Admin/Pic/insert');?>" method="post" enctype="multipart/form-data">
                                <!-- <div class="form-group">
                                    <label>选择图片主人</label>
                                    <select class="form-control" name="hostId">
                                        <?php if(is_array($hosts)): foreach($hosts as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>" <?php echo ($hostId == $vo['id'] ? selected : ''); ?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>图片分类</label>
                                    <select class="form-control" name="fenlei">
                                        ...
                                        <option value="0" <?php echo ($fenlei == '0' ? selected :''); ?>>手机图片</option>
                                        <option value="1" <?php echo ($fenlei == '1' ? selected :''); ?>>配件图片</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="yongtu">
                                        ...
                                        <option value="1">详情图</option>
                                        <option value="2">参数图</option>
                                ...
                                <div class="form-group">
                                    <label>图片的序列号</label>
                                    <input name="xu" type="text" class="form-control" >
                                </div>
                                <?php if($fenlei == 0 ): ?><div class="form-group">
                                    ...
                                    <?php if(is_array($colors)): foreach($colors as $key=>$vo): ?><label class="radio-inline">
                                            <input name="color" type="radio" value="<?php echo ($key); ?>"><?php echo ($vo); ?>
