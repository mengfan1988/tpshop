        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
					<form action="<?php echo U('Admin/Group/index');?>">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">权限组名称</th>
                                <th class="sorting" aria-label="Browser: activate to sort column ascending" style="width: 180px;">拥有权限</th>
                        ...
                        <tbody>
							<?php if(is_array($groups)): foreach($groups as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                <td class="sorting_1"><?php echo ($vo['id']); ?></td>
                                <td><?php echo ($vo['title']); ?></td>
                                <td><?php if(is_array($vo['rules'])): foreach($vo['rules'] as $key=>$vo2): ?><span class="tdspan"><?php echo ($vo2); ?></span><?php endforeach; endif; ?>
                                    
                                </td>
                                <td class="center">
                                	<a href="<?php echo U('Admin/Group/edit', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-edit"></i></a>&nbsp;
                                	<a href="<?php echo U('Admin/Group/delete', array('id'=>$vo['id']));?>" class="btn btn-primary btn-circle"><i class="fa fa-times"></i></a>
                                </td>
