        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    ...
                    <div class="col-sm-6">
                        <form action="<?php echo U('Admin/Phone/index');?>">
                    <div class="dataTables_length" id="dataTables-example_length"><label>显示 
                    	<select name="num" aria-controls="dataTables-example" class="form-control input-sm">
                    		...
                    		<option value="100" <?php if($num == 100 ): ?>selected='selected'<?php endif; ?>>100</option>
                                ...
                                <label>搜索:<input type="search" name="keyword" placeholder="手机标题" class="form-control input-sm" value='<?php echo ($keyword); ?>'placeholder="" aria-controls="dataTables-example"><button class="btn btn-primary">搜索</button></label></div></div></div><div class="row"><div class="col-sm-12">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="margin-top:10px"></form>
                        </form>
                        <thead>
                            <tr role="row">
                            <th  aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="">ID</th>

                            <th   aria-label="Browser: activate to sort column ascending" style="width:150px">手机标题</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" >系列</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" >型号</th>
                            ...
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" >网络</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" >库存</th>
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width:100px">颜色</th>
                            ...
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">尺寸</th>
                            ...
                            <th  tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width:180px">操作</th></tr>
                        </thead>
                        <tbody>
							<?php if(is_array($phones)): foreach($phones as $key=>$vo): ?><tr class="gradeA odd" role="row">
                                <td class="sorting_1"><?php echo ($vo['id']); ?></td>
                                <td><?php echo ($vo['phonename']); ?></td>
                                <td><?php echo ($vo['series']); ?></td>
                                <td><?php echo ($vo['type']); ?></td>
                                <td><?php echo ($vo['price']); ?></td>
                                <td><?php echo ($vo['preprice']); ?></td>
                                <td><?php echo ($vo['network']); ?></td>
                                <td><?php echo ($vo['stock']); ?></td>
                                <td><?php echo ($vo['phonecolor']); ?></td>
                                
                                <td>
                                    <?php switch($vo['status']): case "0": ?>普通<?php break;?>
                                        <?php case "1": ?>新品<?php break;?>
                                        <?php case "2": ?>爆款<?php break;?>
                                        <?php case "3": ?>促销<?php break; endswitch;?>

                                </td>
                                <td><?php echo ($vo['screensize']); ?></td>
                                <td><img src="<?php echo ($vo['pic']); ?>" style="width:30px"></td>
                               
                            
                                <td class="center">
                                    <!-- <a href="{:U('Admin/Phone/edit', array('id'=>$vo['id']))}" class="btn btn-primary btn-circle"><i class="fa fa-edit"></i></a>&nbsp; -->
                                    <a href="<?php echo U('Admin/Phone/edit', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i>修改</a>    
                                    <a href="<?php echo U('Admin/Phone/delete', array('id'=>$vo['id']));?>"  class="btn btn-success btn-xs"><i class="fa fa-times"></i>删除</a>
<!--                                    <a  class="btn btn-success btn-xs deletewo" ids={$vo['id']}><i class="fa fa-times"></i>删除</a>    -->
<a  title="添加图片" href="<?php echo U('Admin/Pic/add', array('hostId'=>$vo['id'],'fenlei'=>'0'));?>" class="btn btn-success btn-xs"><i class="fa fa-file-picture-o"></i>图片</a> <br>    
                                    <a style="margin-top: 5px" title="添加赠品或套餐" href="<?php echo U('Admin/Gift/add', array('phoneId'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-link"></i>添加</a>    
                                    <a style="margin-top: 5px" href="<?php echo U('Admin/Phone/xiajia', array('id'=>$vo['id']));?>" class="btn btn-success btn-xs"><i class="fa fa-long-arrow-down"></i>下 架</a>    
                                    <!-- <a href="{:U('Admin/Phone/delete', array('id'=>$vo['id']))}" class="btn btn-primary btn-circle"><i class="fa fa-times"></i></a> -->
