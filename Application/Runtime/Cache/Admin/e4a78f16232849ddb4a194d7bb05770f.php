...
<link rel="stylesheet" href="/buy/Public/uploadify/uploadify.css" />
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">添加验证规则</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>  
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6" style="width:100%;">
                            <form role="form" action="<?php echo U('Admin/Rule/insert');?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>规则名称</label>
                                    <input name="title" type="text" class="form-control" placeholder="请填写规则名称">
                                </div>
                                <div class="form-group">
                                    <label>规则</label>
                                    <input name="name" type="text" class="form-control" placeholder="规则格式为:控制器/方法名">
                                </div>
