...
<style>
    ...
    <div class="widget" style="width:600px;margin:0px auto">
        <div class="widget-head">
            <div class="pull-left">投诉列表</div>
            ...
            <table class="table table-striped table-bordered table-hover" width="400">
                <thead>
                    ...
                    <tr>
                        <th>是否解决</th>
                        <td>
                            <?php if($data['status'] == 1): ?>未解决<?php endif; ?>
                        </td>
                    </tr>
                </thead>
            </table>
        ...
        <div style="text-align:right">
            <a target="_blank" href="https://mail.qq.com/cgi-bin/loginpage" style="float:left;color:#fff;margin-left:10px;display:inline-block;width:50px;height:20px;background:#ED9C28;text-align:center;border-radius:3px;line-height:20px;">发邮件</a>
            <a href="/buy/Admin.php/Complain/save/id/<?php echo ($data["id"]); ?>" style="margin-right:10px;color:#fff;margin-left:10px;display:inline-block;width:50px;height:20px;background:#5AC64E;text-align:center;border-radius:3px;line-height:20px;">已解决</a>
        </div>
    </div>  
