...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <![endif]-->
      <link rel="shortcut icon" href="/buy/Public/Home/Images/favicon.ico">
     <script type="text/javascript" src="/buy/Public/Home/js/jquery-1.8.3.min.js"></script>   
     <script type="text/javascript" src="/buy/Public/Home/js/head_footer.js"></script>   
 
<link rel="stylesheet" type="text/css" href="/buy/Public/Home/Css/index.css" media="all">
  ...
  <div class="bottom-area">
    <div class="wrapper">
      <a class="js-open-menu" href="#">
        ...
        <a href="">
          <!-- <img alt="" src="/buy/Public/Home/Images/oppo_logo.png"> -->
          <img src="/buy/Public<?php echo $_SESSION['web']['pic']?>">
        </a>
      ...
      <a class="js-open-user" href="#">
        <img alt="" src="/buy/Public/Home/Images/icon-menu-user.png">
      </a>
      <div class="main-menu">
...
<script type="text/javascript" src="/buy/Public/home/js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="/buy/Public/home/js/index.js"></script>
  ...
  <style type="text/css">
    ...
    #images .left_1{z-index:3}
    #images .right_1{z-index:3}
    #images_1 .cur{ background:white;}
    #images_1 li{
        width:15px;
        height:15px;
        float:left;
  ...
  #images_1 li:hover{border-color:#2aad6f;background:white;}
    /*左侧按钮*/
    #images .left_1{
               position:absolute;
               z-index:3;
...
<!--轮播start-->
<div id="images">
  <div class="left_1 icon icon-prev"></div>
    <div class="right_1 icon icon-next" ></div>
      <ul id="img">
        <li>
          <img class="imgs"  src="/buy/Public/home/Images/0.jpg"/>
        </li>
        <li>
          <img class="imgs" src="/buy/Public/home/Images/1.jpg"/>
        </li>
        <li>
          <img class="imgs" src="/buy/Public/home/Images/2.jpg"/>
        </li>
      </ul>
      <ul id="images_1">
        <li class="cur"></li>
...
<div class="wrapper">
  ...
  <a href="
  " target="_top">
    <img alt="OPPO R7" title="OPPO R7" class="feature-product-image" src="/buy/Public/Home/Images/20150730120704w5ejybgsu9dkcupr.jpg">
  ...
  <a href="
  " target="_top">
    <img alt="OPPO R7 Plus" title="OPPO R7 Plus" class="feature-product-image" src="/buy/Public/Home/Images/20150730120707cbcf7wxmnwnbsh3h.jpg">
    <div class="feature-product-content">
      <h2 class="feature-product-heading"></h2>
      <p class="feature-product-description">
        <strong></strong>
  ...
  <div class="g g-wrapper-l">
    <section class="gi one-whole lap-one-third">
      ...
      <h3 class="h-epsilon"><a href="
      " target="_top">了解OPPO品牌故事</a></h3>
      <div class="video home-media-image">
        <a href="
        " target="_top"><img class="video-bg" src="/buy/Public/Home/Images/exploration.jpg"></a>
      </div>
    </section>
    <section class="gi one-whole lap-one-third">
      <h2 class="h-delta">
      ...
      <h3 class="h-epsilon"><a href="
      " target="_top">了解OPPO最新市场动态</a></h3>
                    <article class="news">
          <a href="
          " target="_top"><img class="news-photo" src="/buy/Public/Home/Images/201509091109236nh22opbzk5xtgbu.jpg"></a>
            <div class="news-text">
               <p><a href="
               ">OPPO正式签约巴萨成官方合作伙伴 助力品牌国际化</a></p>
            </div>
        </article>
              <article class="news">
          <a href="" target="_top"><img class="news-photo" src="/buy/Public/Home/Images/20150907050903rqk5lczywhkb5smm.jpg"></a>
            <div class="news-text">
               <p><a href="">OPPO现身诺坎普,巴萨主场首秀获胜</a></p>
            </div>
        </article>
              <article class="news">
          <a href="" target="_top"><img class="news-photo" src="/buy/Public/Home/Images/20150821020806jb2nfyndezxvdqod.jpg"></a>
            <div class="news-text">
               <p><a href="">OPPO全美超模时尚派对嗨翻洛杉矶</a></p>
            </div>
        </article>
                </section>
    <!-- <section class="gi one-whole lap-one-third home-media-weibo" id="home-media-weibo"><iframe class="share_self" scrolling="no" src="/buy/index.php/Index/index1.html" frameborder="0" height="370" width="100%"></iframe></section> -->
  </div>
</div>    </aside>
  ...
  <div class="wrapper g">
        ...
        <a href="" target="_top">                   
          <img alt="OPPO会员" title="OPPO会员" src="/buy/Public/Home/Images/20150424100432DUzqqHBZFJg0niWe.jpg">
          ...
          <div class="access-icon gi lap-one-quarter one-half">
        <a href="" target="_top">
          <img alt="OPPO帮助中心" title="OPPO帮助中心" src="/buy/Public/Home/Images/201507100707184dcfztrj2gmbq8jn.jpg">
          ...
          <div class="access-icon gi lap-one-quarter one-half">
        <a href="<?php echo U('Dian/index');?>" target="_top">
          <img alt="OPPO体验店" title="OPPO体验店" src="/buy/Public/Home/Images/20150424100444rumprgfyzkzisxe7.jpg">
          ...
          <div class="access-icon gi lap-one-quarter one-half">
        <a href="" target="_top">
          <img alt="OPPO品牌" title="OPPO品牌" src="/buy/Public/Home/Images/20150424100426gyn8afg8uuflsuzr.jpg">
  ...
  <div class="footer-prominent-area">
    ...
    <a class="footer-prominent-button
          primary
        " href="" title="OPPO社区" target="_top"><span class="img"><img alt="OPPO社区" title="OPPO社区" src="/buy/Public/Home/Images/201502270202233fz8vzjujgb2ysln.png"></span><span class="text">OPPO社区</span></a>
  </div>
    <div class="gi lap-one-third">
    <a class="footer-prominent-button
          secondary
        " href="" title="ColorOS" target="_top"><span class="img"><img alt="OPPO ColorOS" title="ColorOS" src="/buy/Public/Home/Images/20150227020237cluxgmcj3uhukic0.png"></span><span class="text">ColorOS</span></a>
  </div>
    <div class="gi lap-one-third">
    <a class="footer-prominent-button
          primary
        " href="<?php echo U('App/Appindex');?>" title="软件商店" target="_top"><span class="img"><img alt="OPPO软件商店" title="软件商店" src="/buy/Public/Home/Images/20150314030306rfyfrtucs1nb3wtq.png"></span><span class="text">软件商店</span></a>
  </div>
    </div>  </div>
    ...
    <div class="wrapper">
      <div class="footer-social lap-one-half desk-lap-one-third"><p>
          ...
          <a href="#" id="footer-wx" class="relative">
            ...
            <!-- <img src="/buy/Public/Home/Images/wxwx.png" class="wx-float">  -->
          </a>
