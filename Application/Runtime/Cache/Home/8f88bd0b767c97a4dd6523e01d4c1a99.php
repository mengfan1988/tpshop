...
<link rel="stylesheet" type="text/css" href="/20160727/buy/Public/Home/Css/person_order.css" media="all">
<script type="text/javascript" src="/20160727/buy/Public/Home/js/order_detail.js"></script>
...
<div class="nav-search">
  ...
  <li>
    <a href="<?php echo U('Index/index');?>">
      ...
      <span>/</span>
          ...
          <li>
                  <a href="<?php echo U('Person/my_order');?>">
            我的订单
            <span>/</span>
          </a>
              </li>
          <li>
                  <?php echo ($xingxi['orderNum']); ?>
              </li>
      </ul>
  ...
  <ul class="navigation">
    <li class="">
      <a href="<?php echo U('Person/index');?>">个人首页</a>
    </li>
    <li class="is-active">
      <a href="<?php echo U('Person/account');?>">账户信息</a>
    </li>
    <li class="">
      <a href="<?php echo U('Person/addr');?>">配送地址</a>
    </li>
    <li class="">
      <a href="<?php echo U('Person/my_order');?>">我的订单</a>
    </li>
    <li class="">
      <a href="<?php echo U('Person/xtxx');?>">系统消息</a>
    </li>
    <li class="">
      <a href="<?php echo U('Person/youhui');?>">优惠券</a>
    </li>
  </ul>
</div>
  ...
  <div class="gi one-whole desk-three-quarters pull-left">
    <div class="one-whole lap-width-auto">
      <input id="order-number" value="150916211958742" type="hidden">
      <span>订单编号：<strong><?php echo ($xingxi['orderNum']); ?></strong></span>
    </div>
    <!-- <div class="one-whole lap-width-auto">
      <span>订单状态：未付款</span>
    </div> -->
    <div class="gi one-whole lap-width-auto">
      ...
      <!-- <div class="gi pull-left">
                <a class="box-link" href="#">取消订单</a>
              </div> -->
    </div>
  </div>
  <div class="gi one-whole desk-one-quarter pull-left desk-text-align-right">
    <span>下单时间： <?php echo date('Y-m-d H-i-s',$xingxi['time']);?></span>
  </div>
</div>
...
<div class="order-list">
  <div class="order-summary">
    <div class="order-show-item one-whole lap-one-half desk-one-half">
      ...
      <div class="row">收&nbsp;&nbsp;件&nbsp;&nbsp;人：<?php echo ($dizhi['shou']); ?></div>
      <div class="row">收货地址：<?php echo ($dizhi['address']); ?></div>
      <div class="row">联系电话：<?php echo ($dizhi['tel']); ?></div>
      <!-- <div class="row">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：1006131938@qq.com</div> -->
    </div>
    <div class="order-show-item one-whole lap-one-half desk-one-half">
      <div class="title">支付及配送信息：</div>
      <div class="row">支付状态：<?php echo ($xingxi['pay']==0?'未付款':'在线支付'); ?></div>
      <div class="row">配送状态：<?php switch($xingxi['yunshu']): case "0": ?>未发货<?php break;?>
                                            <?php case "1": ?>圆通<?php break;?>
                                            <?php case "2": ?>顺丰<?php break; endswitch;?></div>
      <!-- <div class="row">：<span class="color-primary">未配货</span></div> -->
      <!-- <div class="row">：未支付</div> -->
      <div class="row">发票抬头：<?php echo ($xingxi['fapiao']); ?></div>
          </div>
  </div>
</div>
...
<div class="g clearfix">
  <div class="order-product-list brick-shadow one-whole desk-two-thirds pull-left">
    <div class="order-good-title">商品清单：</div>
     <?php if(is_array($goods)): foreach($goods as $key=>$vo): if($vo['fenlei'] == 0): ?><div class="goods-list">
          <div class="goods-list-show">
            <a class="goods-list-image" href="#" target="_top">
                            <img src="<?php echo ($vo['good']['pic']); ?>">
                          </a>
          </div>
          <div class="goods-list-detail">
              ...
              <div class="goods-list-description">
                <h4 class="heading">
                  <a href="#" target="_top"><?php echo ($vo['good']['phoneName']); ?>
                  </a>
                </h4>
                <p><?php echo ($vo['color']); ?></p>
              </div>
              <div class="goods-list-quantity"><strong>×<?php echo ($vo['num']); ?></strong></div>
              <div class="goods-list-price"><strong>￥<?php echo ($vo['good']['price']); ?></strong></div>
            </div>
               <?php if(empty($vo['meal']) == false ): ?><div class="goods-list-info goods-list-attach goods-list-gift">
                  <div class="goods-list-description">
                    <i class="goods-list-flag-gift">套餐</i>
                    <a href="#" target="_top"><?php echo ($vo['meal']['partName']); ?></a>
                  </div>
                  <div class="goods-list-quantity">×<?php echo ($vo['num']); ?></div>
                <div class="goods-list-price">￥<?php echo ($vo['meal']['price']); ?></div>
                  
                </div><?php endif; ?> 
                <?php if(empty($vo['fuwuId']) == false): ?><div class="goods-list-info goods-list-attach goods-list-gift">
                  <div class="goods-list-description">
                    <i class="goods-list-flag-gift">服务</i>
                    <a href="#" target="_top"> <?php switch($vo['fuwuId']): case "1": ?>半年<?php break;?>
                                            <?php case "2": ?>一年<?php break; endswitch;?></a>
                  </div>
                  <div class="goods-list-quantity">×<?php echo ($vo['num']); ?></div>
                  <div class="goods-list-price">￥<?php switch($vo['fuwuId']): case "1": ?>79<?php break;?>
                                            <?php case "2": ?>129<?php break; endswitch;?></div>
                  
                </div><?php endif; ?>   
                <?php if(empty($vo['zeng']) == false): if(is_array($vo['zeng'])): foreach($vo['zeng'] as $zk=>$zvo): ?><div class="goods-list-info goods-list-attach goods-list-gift">
                  <div class="goods-list-description">
                    <i class="goods-list-flag-gift">赠品</i>
                    <a href="#" target="_top"><?php echo ($zvo['partName']); ?></a>
                  </div>
                  <div class="goods-list-quantity">×<?php echo ($vo['num']); ?></div>
        ...
        <?php elseif($vo['fenlei'] == 1): ?>
          ...
          <div class="goods-list-detail">
              ...
              <div class="goods-list-description">
                <h4 class="heading">
                  <a href="#" target="_top"><?php echo ($vo['good']['partName']); ?>
                  </a>
                </h4>
  ...
  <div class="total-price slab-extra-light gi one-whole desk-one-third">
    ...
    <ul>
      <li>
        ...
        <span class="amount"><?php echo ($xingxi['count']); ?></span>
      </li>
      <li>
        <span class="product">总价：</span>
        <span class="amount">￥<?php echo ($xingxi['qian']); ?></span>
      </li>
    </ul>
    <!-- <ul>
      <li>
    ...
    <div class="total">
      ...
      <span class="price">￥<?php echo ($xingxi['qian']); ?></span>
    </div>
      <?php if($xingxi['pay'] == 0): ?><div class="total one-whole desk-text-align-right">
      <a class="button button-s fukuan" href="#" ordernum="<?php echo ($xingxi['orderNum']); ?>" qian="<?php echo ($xingxi['qian']); ?>">立即支付</a>
    </div><?php endif; ?>
          </div>
</div>
...
<div class="form-actions brick-shadow lap-invisible">
  <div class="form-actions-left">
    <a class="button-light" href="<?php echo U('Person/my_order');?>">返回订单列表</a>
  </div>
</div>
      </div>
    </div>
...
<div class="gi lap-one-half">
	  ...
	  <div id="return-error" class="hidden">
			...
			<div class="dialog-common dialog-box-common">
				<div class="dialog-container">
					<a class="dialog-close-common">×</a>
					<div class="dialog-content-common"><div class="dialog-common-content">
												</div><div class="field dialog-btn">
							<div class="g g-wrapper-s">
			...
			<div class="dialog-common dialog-box-common">
				<div class="dialog-container">
					...
					<div class="dialog-content-common">
						...
						</div><div class="dialog-common-content"><p>请及时带上需退换的商品，选择就近的售后服务中心进行退换货业务办理。</p><p>为了方便您及时办理退换货业务，建议立即<a href="#" target="_top">预约售后服务中心&gt;&gt;</a></p><p>如有疑问，请查看<a href="#" target="_top">退换货流程说明</a>或联系我们的<a id="btn-kf" href="#" target="_top">在线客服</a>，我们将竭诚为您服务，感谢您对OPPO的支持！</p>
												</div><div class="field dialog-btn">
							<div class="g g-wrapper-s">
								<div class="gi lap-one-whole">
									<a class="button button-one-whole">好的</a>
			...
			<div class="dialog-common dialog-box-common">
				<div class="dialog-container">
					...
					<div class="dialog-content-common">
						...
						</div><div class="dialog-common-content">
												</div>
												<div class="field dialog-btn">
							<div class="g g-wrapper-s"><div class="gi lap-one-half">
									<a class="button button-one">确定</a>
								</div>
								<div class="gi lap-one-half">
									<a class="button-light button-two">取消</a>
