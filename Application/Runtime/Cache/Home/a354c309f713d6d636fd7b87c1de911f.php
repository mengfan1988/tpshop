...
<link rel="stylesheet" type="text/css" href="/20160727/buy/Public/Home/Css/addr.css" media="all">
<script type="text/javascript" src="/20160727/buy/Public/Home/Js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="/20160727/buy/Public/Home/Js/person_addr.js"></script>
...
<div class="nav-search">
 ...
 <ul class="navigation">
    ...
    <li class="">
      ...
      <form action="http://store.oppo.com/user/addresses" class="g">
    ...
    <div class="brick-shadow">
      <div class="radio-title">
        <strong>我们默认首选顺丰快递，如收货地址顺丰快递不能送达，我们会更改为EMS快递为您配送。</strong>
          ...
          <div style="display: none;" class="address-form" data-address-id="482786">
            <div id="address-edit-482786" class="g">
  <div class="gi field lap-one-whole desk-one-quarter">
    <label>*收货人姓名</label>
    <input name="id" value="" type="hidden">
    <input name="shou"  type="text">
  </div>
  <div class="g">
    <div class="gi field lap-one-whole desk-one-quarter">
      <label>*手机号码</label>
    ...
    <div class="g">
      <div class="gi desk-two-thirds one-whole">
        <input class="address-detail" name="address"  type="text">
      </div>
    </div>
  </div>
  ...
  <div class="form-actions">
    <div class="pull-left">
      <a class="button-light pull-left address-update" >保存</a>
      <a class="button-light pull-left address-cancel" >取消</a>
    </div>
  </div>
  <div class="dividing-line"></div>
</div>
</div>
       <?php if(is_array($info)): foreach($info as $key=>$info): ?><div style="display: block;" class="field radio-item dark xl">
            
            <span class="radio mozilla mozilla41 not_msie custom-form_radio482786 <?php echo ($key == 0? 'checked_radio':''); ?>">
            <input id="radio482786" name="r6" value="482786" checked="checked" type="radio"></span>
              <label for="radio482786">
                <div class="g address-form-content">
                  <div class="gi desk-one-fifth one-whole"><?php echo ($info['shou']); ?></div>
                  <div class="gi desk-one-fifth one-whole"><?php echo ($info['tel']); ?></div>
                  <!-- <div class="gi desk-one-fifth one-whole">380418209@qq.com</div> -->
                  <div class="gi desk-two-fifths one-whole"><?php echo ($info['address']); ?></div>
                </div>
                <div class="links">
                  <a class="bianji" data-id="<?php echo ($info['id']); ?>" data-shou="<?php echo ($info['shou']); ?>" data-tel="<?php echo ($info['tel']); ?>" data-addr="<?php echo ($info['address']); ?>">编辑</a>
                  <a class="remove-address sc" data-id="<?php echo ($info['id']); ?>">删除</a>
                </div>
              </label>
      ...
      <a class="button-light field" id="address_new">添加新地址</a>
      <div class="js-content address-form-new" style="display: none;" id="tjxsy">
        <div id="address-create" class="g">
  <div class="gi field lap-one-whole desk-one-quarter">
    <label>*收货人姓名</label>
    <input value="" name="receiver" type="text">
  </div>
  <div class="g">
    <div class="gi field lap-one-whole desk-one-quarter">
      <label>*手机号码</label>
  ...
  <div class="g">
    <div class="gi desk-two-thirds one-whole">
      <input class="address-detail" name="address-detail" value="" placeholder="详细街道地址" type="text">
    </div>
  </div>
</div>
  ...
  <div class="form-actions">
    <div class="pull-left">
      <a class="button-light pull-left address-store" >保存</a>
      <a class="button-light pull-left address-new-cancel" >取消</a>
    </div>
  </div>
</div>
      </div>
