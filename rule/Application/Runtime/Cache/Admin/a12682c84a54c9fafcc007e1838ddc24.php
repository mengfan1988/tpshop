...
function admin_add(){
		...
		$.post(	"/rule/index.php/Admin/Admin/admin_add/menu_title/%E7%B3%BB%E7%BB%9F%E7%AE%A1%E7%90%86%20-%20%E6%B7%BB%E5%8A%A0%E7%AE%A1%E7%90%86%E5%91%98",{"account":account,"password":password,"group_id":group_id},function(data){
				if(data == 1){
...
<div class="nav">
	<div class="nav_title">
    	<h4><img class="nav_img" src="/rule/Public/Admin/img/tab.gif"><span class="nav_a">添加管理员</span></h4>
    </div>
</div>
<div class="list">
